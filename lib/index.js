 ...
 * @param {Object} options.retext - passed to retext plugin
 ...
 * @param {Function} options.parser - copied directly to output
...
module.exports = function reshapeStandard (options = {}) {
  ...
  const includeOpt = selectiveMerge(options, ['root', 'alias', 'parserRules'])
